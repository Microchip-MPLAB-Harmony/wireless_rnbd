...
1.  Create MPLAB Harmany Project with below device and DFP version
	...
	**1.1** Create new 32-bit MCC Harmony Project as shown below
    ...
    ![](images/GUID-1F5749EC-E7B4-4523-897D-672357706EC6-low.png)
    ...
    **1.2** Select the **Framework Path** \(Framework path must match SDK setup<br /> document\)and select **Next**
    ...
    ![](images/GUID-3D19DD6B-F7D5-4C0D-BEA5-77D8003FC859-low.png)
    ...
    **1.3** Select Project Folder and select Next
    ...
    ![](images/GUID-F1A8A999-FE9E-4D8F-9DE7-1152FB95BB02-low.png)
    ...
    **1.4** Select the device "ATSAML21J18B" for standalone project using the SAML21<br /> device family in the "Target Device" and click Finish
    ...
    ![](images/GUID-DD58810C-576C-4209-91DB-EB30366EBD70-low.png)
    ...
    **1.5**MPLABx Code Configurator will be launched automatically. Then Select<br /> **"MPLAB Harmony"** and Click Next for the Harmony Framework<br /> Path.
    ...
    ![](images/GUID-294FFF44-97E6-44FA-B024-CF107A950910-low.png)
    ...
    **1.6** Select **"Finish"**
    ...
    ![](images/GUID-12B3E149-2BA4-49D7-8518-4E0AF4053503-low.png)
    ...
    **1.7** Project Graph window of the Configurator may have predefined<br /> components
    ...
    ![](images/GUID-B7BABF5E-8835-4450-AE8F-4756671D5621-low.png)
    ...
    ![](images/GUID-AFFFE743-53B2-4936-955F-91C9AD625657-low.png)
...
2.  After creating the project as shown in the above step go to device resource and verify RNBD was under Wireless component
    ...
    ![](images/GUID-8D6AAFC9-672F-4CEF-8A42-B848019EE289-low.png)
    ...
    ![](images/GUID-C082E138-AB16-4561-B37C-8167A1EB3862-low.png)
...
3.  Project Graph and RNBD/RN487x Module Configuration
    ...
    ![](images/GUID-F82D5FA9-3ECA-4676-9866-B7236D123102-low.png)
    ...
    ![](images/GUID-20676429-4B4E-45F0-AFB6-2F9F24A05C90-low.png)
...
4.  Selecting Example Application
    ...
    ![](images/GUID-C4728BF0-3624-47F6-BB59-D0D48ABE4304-low.png)
    ...
    **4.1. Basic Data Exchange:**
    ...
    -   Basic Data Exchange uses only **ONE** SERCOM for the Data Transmission
        ...
        ![](images/GUID-7362913E-214A-4A5B-8025-EB5978FD83AA-low.png)

        <br />

        <br />

        ![](images/GUID-6D4F728F-800C-44DA-8DBA-D38FE09C05E2-low.png)

        <br />

        <br />

        ![](images/GUID-E0F435FE-B243-4B32-83CB-733D18E84AFB-low.png)

        <br />

        <br />

        ![](images/GUID-1278FF0D-6D3C-4B0F-AE4D-89F168518DAF-low.png)
        ...
        **4.2. Transparent UART:**
        ...
        -   Transparent UART Application uses **TWO** SERCOM as a Dependency for the Data Transmission
            ...
            ![](images/GUID-0B984F72-4BD1-4A0E-A500-8F5E47635AAE-low.png)

            <br />

            <br />

            ![](images/GUID-8DFAD094-DC6C-452C-8B76-A8959FA8751A-low.png)
            ...
            ![](images/GUID-65B59EB7-F897-4632-B540-900B80FA985B-low.png)

            <br />

            <br />

            ![](images/GUID-69A388D7-1519-4EF6-8846-F793F2DA432E-low.png)
...
5.  PIN Settings for Example Application:
    -   Basic Data Exchange Pin Settings
        ...
        ![](images/GUID-7799CCD7-257F-4372-A8B4-38B82D8D2EC6-low.png)
    ...
    -   Transparent UART Pin Settings
        ...
        ![](images/GUID-1B561392-5A32-454E-BA0F-68DBF4D5201F-low.png)
...
6.  Code Generation and adding the example application to main.c
    ...
    -   After making the all the above settings click on Generate in which code will be generated for RNBD or RN487x as per the selection
        ...
        ![](images/GUID-1C36EEDF-61DE-4BCF-B7C8-E249E7AF5651-low.png)
    ...
    -   Once after Generation is complete include the headers for **RNBD** or **RN487x** as shown below
        ...
        -   if **Select Module Type** is selected for **RN487x**: \#include "examples/rn487x\_example.h"
            ...
            ![](images/GUID-31D005A3-ADEE-47E8-8312-1BBCAF0AEE53-low.png)
...
7.  Build the Generated Project:
    ...
    ![](images/GUID-69F2DB5D-6EEE-4922-935E-A0A0FB0E19F8-low.png)
...
8.  Program to the Development Board
    ...
    ![](images/GUID-86E3F2BD-3777-4E96-95C3-F1C8DED00136-low.png)
...
1.  Create MPLAB Harmany Project with below device and DFP version
    ...
    -   DFP: PIC32CM-LS\_DFP \(v1.1.162\)
        ...
        **1.4** Select the device "PIC32CM5164LS00100" for standalone<br /> project using the PIC32CM-LS device family in the "Target Device"<br /> and click Finish
        ...
        ![](images/GUID-5F1FF3AB-ECC8-4737-A413-94BF029B8BA6-low.png)
        ...
        **1.7** Project Graph window of the Configurator may have<br /> predefined components
        ...
        ![](images/GUID-854E224C-04F1-4BDA-85F6-9B80E67341E8-low.png)
...
2.  After creating the project as shown in the above step go to device resource and verify RNBD was under Wireless component
    ...
    ![](images/GUID-90230AC0-170B-49BE-8966-59DBCE84E4B8-low.png)
    ...
    ![](images/GUID-897EAA48-0C5B-45F0-A3BA-E426618531C2-low.png)
...
3.  Project Graph and RNBD/RN487x Module Configuration
    ...
    ![](images/GUID-E98E66A5-023F-4A59-A415-188A9407B727-low.png)
    ...
    ![](images/GUID-2B7B2E95-2F31-4C72-BBFB-2ED03594AC60-low.png)
...
4.  Selecting Example Application
    ...
    ![](images/GUID-1183333D-3FE6-47A6-9A1C-DB89187FC07F-low.png)
    ...
    **4.1 Basic Data Exchange:**
    ...
    -   Basic Data Exchange uses only **ONE** SERCOM for the Data Transmission
        ...
        ![](images/GUID-F906B088-0615-48F2-8E9B-2BBD390714F4-low.png)

        <br />

        <br />

        ![](images/GUID-237C2D6E-AB20-4D66-9BF5-B4967B189A89-low.png)

        <br />

        <br />

        ![](images/GUID-934D5E9F-070D-4C79-BBD8-E1FAB742B8AA-low.png)
        ...
        **4.2 Transparent UART**
        ...
        -   Transparent UART Application uses **TWO** SERCOM as a Dependency for the Data Transmission
            ...
            ![](images/GUID-C123B1D2-B140-478F-986F-05CBE5F5F778-low.png)
            ...
            ![](images/GUID-3DDB61A1-88A2-4684-AD19-EFEEA45F6764-low.png)
...
5.  PIN Settings for Example Application:
    ...
    -   Basic Data Exchange Pin Settings
        ...
        ![](images/GUID-C9051DF7-2E47-4890-953A-FF5408FA7A47-low.png)
    ...
    -   Transparent UART Pin Settings
        ...
        ![](images/GUID-13237D2B-D9C8-4BCF-9495-8EB4AF31F439-low.png)
...
6.  Enabling RNBD/RN487x Secure and Non Secure for Trust Zone Devices
    ...
    ![](images/GUID-55BAA7ED-4492-464B-9C33-38369A61A792-low.png)
    ...
    -   **Case1:** \(RNBD: Non-Secure, Dependency: Non-Secure, BT\_RST Pin: Non-Secure\)
        ...
        -   **Dependency –\> Non-Secure**
            ...
            -   Goto –\> Project Graph –\> expand the plugins drop down –\> and select Arm TRUSTZONE for Armv8-M
                ...
                ![](images/GUID-66D4E1DA-5032-4A14-8035-EE95C5F3C769-low.png)
            ...
            -   Select **Peripheral Configuration** as shown<br /> below
                ...
                ![](images/GUID-F21C855A-415F-4609-A5E0-843B0D21BF86-low.png)
            ...
            -   **NOTE:** Set SERCOM2 from secure to Non-Secure as shown below \(Applicable for **Transparent UART** if **TWO** **SERCOM** was used\)
                ...
                ![](images/GUID-1B755990-97B9-41F3-86B2-BBF85A0F050F-low.png)
        ...
        -   **Pin Settings –\> Non-Secure**
            ...
            -   Goto –\> Project Graph –\> expand the plugins drop down –\> and select Pin Configuration as shown below
                ...
                ![](images/GUID-F462E3AF-C296-496D-9B1A-A453C133EB86-low.png)
            ...
            -   Set **BT\_RST** pin to **Non-Secure** under PIN Security Mode as shown below
                ...
                ![](images/GUID-0B32338D-9798-4785-9004-93F9BDC7A0EE-low.png)
        ...
        -   **Project Structure:**
            ...
            ![](images/GUID-C132E098-4CB8-4CE8-8E88-4B6DEBE1532F-low.png)

            <br />

            <br />

            ![](images/GUID-ACC3BAE3-899F-424B-B448-FF8EFA4E55D6-low.png)
        ...
        1.  **Scenario 1:**
            ...
            -   **RNBD Secure \(Check Box in the UI\) –\> Enable Check \(Secure\)**
                ...
                **Note:** **Generate RNBD Non Secure Entry** check box Disabled \(Unchecked\) as shown below
                ...
                ![](images/GUID-9EE3A6D2-4F83-4524-8538-C79820877CB9-low.png)
            ...
            -   **Pin Settings –\> Secure**
                ...
                -   Set **BT\_RST** pin to **Non-Secure** under PIN Security Mode as shown below
                    ...
                    ![](images/GUID-32A08681-AD83-445E-8B52-970DA3BB4050-low.png)
            ...
            -   **Project Folder Structure:**
                ...
                ![](images/GUID-7B3F7448-3312-4B7E-9A50-D0DB07FA33C6-low.png)
        ...
        2.  **Scenario 2**:
            ...
            -   **RNBD Secure \(Check Box in the UI\) –\> Enable Check \(Secure\)**
                ...
                **Note:** **Generate RNBD Non Secure Entry** check box Enabled \(checked\) as shown below
                ...
                ![](images/GUID-07EBA86D-DDC1-413A-8905-A691BE598C97-low.png)
            ...
            -   **Project Folder Structure:**
                ...
                ![](images/GUID-56BE2E74-91E0-474B-B011-28CBD4BBD0BE-low.png)
...
![](images/GUID-7C8A6EC0-77B8-4206-B2F5-FA8FA50C2A35-low.png)
...
![](images/GUID-8BF59E53-A177-4963-826B-5CC4BB72F35B-low.png)
...
![](images/GUID-8E74C720-BCFD-47D5-A7CC-A02653A6DC80-low.png)
