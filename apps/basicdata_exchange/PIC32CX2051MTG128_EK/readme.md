...
|Device Family Pack \(DFP\) |PIC32CX-MT\_DFP \(v1.3.132\)|Device: PIC32CX2051MTG128|
...
1.  Create MPLAB Harmony Project with below device and DFP version
    ...
    -   Device: PIC32CX2051MTG128
    -   XC32 Compiler: v4.60
    -   DFP: PIC32CX-MT\_DFP \(v1.2.132\)
    <br />
    ...
    **1.2** Select the device "PIC32CX2051MTG128" for application project using the PIC32CXMT device family
