...
|----------------------------|-------|--------|
|MPLAB X IDE|v6.25|[MPLAB X IDE Website](https://www.microchip.com/en-us/tools-resources/develop/mplab-x-ide#tabs)|
|XC32 Compiler|v4.60 or above|[Web](https://www.microchip.com/en-us/tools-resources/develop/mplab-xc-compilers)|
...
|Device Family Pack \(DFP\) |PIC32CZ-CA70\_DFP \(v1.0.10\)|Device: PIC32CZ2051CA70144|
...
1.  Create MPLAB Harmony Project with below device and DFP version
    ...
    -   Device: PIC32CZ2051CA70144
    -   XC32 Compiler: v4.60
    -   DFP: PIC32CZ-CA70\_DFP \(v1.0.10\)
    <br />
    ...
    **1.2** Select the device "PIC32CZ2051CA70144" for application project using the PIC32C device family
...
4.  Selecting Example Application
    ...
    **4.1. Basic Data Exchange:**
    ...
    -   Basic Data Exchange uses only **ONE** SERCOM for the Data Transmission
        ...
        ![](media/USART0_ProjectGraph.png)

        <br />

        ![](media/USART0_Settings.png)
