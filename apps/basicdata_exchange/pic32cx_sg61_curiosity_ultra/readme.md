...
|Device Family Pack \(DFP\) |PIC32cx_SG\_DFP \(v1.2.124\)|Device: PIC32CX1025SG61128|
...
1.  Create MPLAB Harmony Project with below device and DFP version
    ...
    **1.2** Select the device "PIC32CX1025SG61128" for application project using the PIC32CX device family
