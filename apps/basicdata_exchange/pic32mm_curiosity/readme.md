...
|Device Family Pack \(DFP\) |PIC32MM\_DFP \(v1.11.151\)|Device: PIC32MM0064GPL036|
...
1.  Create MPLAB Harmany Project with below device and DFP version
    ...
    **1.2** Select the device "PIC32MM0064GPL036" for application project using the PIC32MM<br /> device family
