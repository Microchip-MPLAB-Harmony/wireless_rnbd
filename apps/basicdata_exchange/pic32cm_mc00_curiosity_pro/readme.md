...
|Device Family Pack \(DFP\) |PIC32CM-LE\_DFP \(v1.4.67\)|Device: PIC32CM1216MC00048|
...
1.  Create MPLAB Harmany Project with below device and DFP version
    ...
    **1.2** Select the device "PIC32CM1216MC00048" for application project using the PIC32CM<br /> device family
