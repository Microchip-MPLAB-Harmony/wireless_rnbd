...
|Device Family Pack \(DFP\) |PIC32MX\_DFP \(v1.6.369\)|Device: PIC32MX470F512H|
...
1.  Create MPLAB Harmany Project with below device and DFP version
    ...
    **1.2** Select the device "PIC32MX470F512H" for application project using the PIC32MX<br /> device family
