...
|Device Family Pack \(DFP\) |SAME54\_DFP \(v3.8.234\)|Device: ATSAME54P20A|
...
1.  Create MPLAB Harmany Project with below device and DFP version
    ...
    **1.2** Select the device "ATSAME54P20A" for application project using the SAME54<br /> device family
