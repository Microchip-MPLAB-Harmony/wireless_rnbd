...
1.  Create MPLAB Harmany Project with below device and DFP version
    ...
    **1.2** Select the device "PIC32CM5164LE00100" for application project using the PIC32CM<br /> device family
    ...
    **1.4** Select the **Framework Path** \(Framework path must match SDK setup<br /> document\) and click Finish
