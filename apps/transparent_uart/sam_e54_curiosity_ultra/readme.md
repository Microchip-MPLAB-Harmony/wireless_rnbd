...
|Device Family Pack \(DFP\)|SAME54\_DFP \(v3.9.244\)|Device: ATSAME54P20A|
...
1.  Create MPLAB Harmany Project with below device and DFP version
    ...
    **1.1** Create new 32-bit MCC Harmony Project as shown below
      ...
      **1.2** Select the device "ATSAME54P20A" for application project using the SAME<br /> device family
...
4.  Selecting Example Application
    ...
    -   Transparent UART Application uses **TWO** SERCOM as a Dependency for the Data Transmission
      ...
      RNBD/RN487x Depenedency0 **SERCOM7** Tx/Rx Pad settings

      ![](media/Sercom_Dependency0_rx_tx_pad_settings.png)

      RNBD/RN487x Depenedency1 **SERCOM1** Tx/Rx Pad settings
